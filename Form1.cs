...
namespace Escaner_DML
{
    public partial class Form1 : Form
    {
        ...
        private void BtnAnalizar_Click(object sender, EventArgs e)
        {
            if (txtEntrada.Text != "")
            {
                ...
                if (Errores.ErrorSimboloDesco(txtEntrada, txtError) == false)
                {
                    ...
                    string tok = ObtenerPalabraEnIndice(txtEntrada, 0);
                    tokens.Add(tok);
                    if (Analisis.errorActivado == false)
                    {
                        ...
                        errorActivado = Analisis.Sintaxis(tokens,tokens2, txtError, txtEntrada, DgvLexica, txtError, DtTablas, DtAtributos, DtRestricciones);
        ...
        private void BtnInicializar_Click(object sender, EventArgs e)
        {
            ...
            tokens = Analisis.Analizador2(txtEntrada, DgvLexica, txtError, DtTablas, DtAtributos, DtRestricciones);
            Analisis.LLENADOTABLASPAPU(DtTablas, DtAtributos, DtRestricciones,tokens);
