...
namespace Escaner_DML
{
    public partial class Form1 : Form
    {
        ...
        private void cmbEjemplo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtEntrada.Text = "CREATE TABLE DEPARTAMENTOS(D# CHAR(2) NOT NULL,DNOMBRE CHAR(6) NOT NULL,CONSTRAINT PK_DEPARTAMENTOS PRIMARY KEY (D#));\r\nINSERT INTO DEPARTAMENTOS VALUES ('D1','CIECOM');INSERT INTO DEPARTAMENTOS VALUES ('D2','CIETIE');INSERT INTO DEPARTAMENTOS VALUES ('D3','CIEING');INSERT INTO DEPARTAMENTOS VALUES ('D4','CIEECO');INSERT INTO DEPARTAMENTOS VALUES ('D5','CIEBAS');\r\nCREATE TABLE CARRERAS(C# CHAR(2) NOT NULL,CNOMBRE CHAR(3) NOT NULL,VIGENCIA CHAR(4) NOT NULL,SEMESTRES NUMERIC(2) NOT NULL,D# CHAR(2) NOT NULL,CONSTRAINT PK_CARRERAS PRIMARY KEY (C#),CONSTRAINT FK_CARRERAS FOREIGN KEY (D#) REFERENCES DEPARTAMENTOS(D#));\r\nINSERT INTO CARRERAS VALUES ('C1','ISC','2010',9,'D1');INSERT INTO CARRERAS VALUES ('C2','LIN','2008',9,'D1');INSERT INTO CARRERAS VALUES ('C3','ICI','2009',10,'D2');INSERT INTO CARRERAS VALUES ('C4','IIN','2010',8,'D3');INSERT INTO CARRERAS VALUES ('C5','LAE','2011',8,'D4');INSERT INTO CARRERAS VALUES ('C6','ARQ','2010',10,'D2');\r\nCREATE TABLE ALUMNOS(A# CHAR(2) NOT NULL,ANOMBRE CHAR(20) NOT NULL,GENERACION CHAR(4) NOT NULL,SEXO CHAR(1) NOT NULL,C# CHAR(2) NOT NULL,CONSTRAINT PK_ALUMNOS PRIMARY KEY(A#),CONSTRAINT FK_ALUMNOS FOREIGN KEY(C#)REFERENCES CARRERAS(C#));\r\nINSERT INTO ALUMNOS VALUES ('A1','ALBA JESSICA','2009','F','C1');INSERT INTO ALUMNOS VALUES ('A2','CARREY JIM','2010','M','C2');INSERT INTO ALUMNOS VALUES ('A3','JOLIE ANGELINE','2011','F','C1');INSERT INTO ALUMNOS VALUES ('A4','SMITH WILL','2012','M','C6');INSERT INTO ALUMNOS VALUES ('A5','MESSI LIONEL','2010','M','C1');INSERT INTO ALUMNOS VALUES ('A6','ESPINOZA PAOLA','2012','F','C6');INSERT INTO ALUMNOS VALUES ('A7','BLANCO CUAHTEMOC','2009','M','C5');INSERT INTO ALUMNOS VALUES ('A8','SANCHEZ HUGO','2010','M','C4');\r\nCREATE TABLE MATERIAS(M# CHAR(2) NOT NULL,MNOMBRE CHAR(6) NOT NULL,CREDITOS NUMERIC(2) NOT NULL,C# CHAR(2) NOT NULL,CONSTRAINT PK_MATERIAS PRIMARY KEY (M#),CONSTRAINT FK_MATERIAS FOREIGN KEY (C#) REFERENCES CARRERAS(C#));\r\nINSERT INTO MATERIAS VALUES ('M1','ESTDAT',10,'C1');INSERT INTO MATERIAS VALUES ('M2','FUNPRO',8,'C2');INSERT INTO MATERIAS VALUES ('M3','CIRCUI',10,'C1');INSERT INTO MATERIAS VALUES ('M4','PAISAJ',10,'C6');INSERT INTO MATERIAS VALUES ('M5','BASDAT',8,'C1');INSERT INTO MATERIAS VALUES ('M6','PROADM',6,'C5');INSERT INTO MATERIAS VALUES ('M7','CONTAB',6,'C5');INSERT INTO MATERIAS VALUES ('M8','ECONOM',8,'C2');INSERT INTO MATERIAS VALUES ('M9','RESMAT',10,'C3');\r\nCREATE TABLE PROFESORES(P# CHAR(2) NOT NULL,PNOMBRE CHAR(20) NOT NULL,EDAD NUMERIC(2) NOT NULL,SEXO CHAR(1)NOT NULL,ESP CHAR(4) NOT NULL,GRADO CHAR(3) NOT NULL,D# CHAR(2) NOT NULL,CONSTRAINT PK_PROFESORES PRIMARY KEY (P#),CONSTRAINT FK_PROFESORES FOREIGN KEY (D#) REFERENCES DEPARTAMENTOS(D#));\r\nINSERT INTO PROFESORES VALUES ('P1','DA VINCI LEONARDO',60,'M','PINT','LIC','D2');INSERT INTO PROFESORES VALUES ('P2','ARQUIMIDES',65,'M','QUIM','MAE','D3');INSERT INTO PROFESORES VALUES ('P3','TURING ALAN',43,'M','COMP','DOC','D1');INSERT INTO PROFESORES VALUES ('P4','EINSTEIN ALBERT',58,'M','GENI','DOC','D1');INSERT INTO PROFESORES VALUES ('P5','CURIE MARIE',45,'F','QUIM','LIC','D3');INSERT INTO PROFESORES VALUES ('P6','HAWKING WILLIAM',52,'M','FISI','DOC','D4');INSERT INTO PROFESORES VALUES ('P7','VON NEWMAN JOHN',47,'M','COMP','MAE','D1');INSERT INTO PROFESORES VALUES ('P8','NEWTON ISAAC',36,'M','FISI','LIC','D3');INSERT INTO PROFESORES VALUES ('P9','THATCHER MARGARET',64,'F','COMP','MAE','D1');\r\nCREATE TABLE INSCRITOS(R# CHAR(3) NOT NULL,A# CHAR(2) NOT NULL,M# CHAR(2) NOT NULL,P# CHAR(2) NOT NULL,TURNO CHAR(1) NOT NULL,SEMESTRE CHAR(6) NOT NULL,CALIFICACION NUMERIC(3) NOT NULL,CONSTRAINT PK_INSCRITOS PRIMARY KEY (R#),CONSTRAINT FK_INSCRITOS_01 FOREIGN KEY (A#) REFERENCES ALUMNOS(A#),CONSTRAINT FK_INSCRITOS_02 FOREIGN KEY (M#) REFERENCES MATERIAS(M#),CONSTRAINT FK_INSCRITOS_03 FOREIGN KEY (P#) REFERENCES PROFESORES(P#));\r\nINSERT INTO INSCRITOS VALUES ('R01','A1','M1','P3','M','2010I',60);INSERT INTO INSCRITOS VALUES ('R02','A1','M5','P4','M','2011I',75);INSERT INTO INSCRITOS VALUES ('R03','A1','M2','P3','V','2010I',78);INSERT INTO INSCRITOS VALUES ('R04','A1','M5','P4','M','2011II',80);INSERT INTO INSCRITOS VALUES ('R05','A2','M3','P6','V','2010I',86);INSERT INTO INSCRITOS VALUES ('R06','A2','M4','P7','V','2010I',90);INSERT INTO INSCRITOS VALUES ('R07','A3','M1','P2','M','2011I',70);INSERT INTO INSCRITOS VALUES ('R08','A3','M5','P9','V','2011II',82);INSERT INTO INSCRITOS VALUES ('R09','A4','M6','P6','M','2010I',90);INSERT INTO INSCRITOS VALUES ('R10','A4','M4','P9','V','2011II',88);INSERT INTO INSCRITOS VALUES ('R11','A4','M7','P9','M','2012I',90);INSERT INTO INSCRITOS VALUES ('R12','A5','M1','P3','M','2010I',78);INSERT INTO INSCRITOS VALUES ('R13','A5','M5','P3','V','2010II',86);INSERT INTO INSCRITOS VALUES ('R14','A5','M7','P9','V','2011II',76);INSERT INTO INSCRITOS VALUES ('R15','A5','M9','P5','V','2011I',92);INSERT INTO INSCRITOS VALUES ('R16','A7','M3','P4','M','2011II',78);INSERT INTO INSCRITOS VALUES ('R17','A7','M2','P8','M','2011I',86);INSERT INTO INSCRITOS VALUES ('R18','A7','M5','P7','M','2011I',94);";
            }
