...
namespace Escaner_DML
{
    public partial class Form1 : Form
    {
        ...
        public List<(string tabla, string alias, int linea)> froms = new List<(string tabla, string alias, int linea)>();
        public List<(string tabla, string atributo, int linea)> selects = new List<(string tabla, string atributo, int linea)>();
        public List<(string tabla, string atributo, string tipo, int linea)> wheres = new List<(string tabla, string atributo, string tipo, int linea)>();
        ...
        private void BtnAnalizar_Click(object sender, EventArgs e)
        {
            if (txtEntrada.Text != "")
            {
                ...
                Analisis Analisis = new Analisis(errorActivado, tablas, atributos, restricciones, selects, froms, wheres);
