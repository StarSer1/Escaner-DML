...
namespace Escaner_DML
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            cad = Analisis.CargarTexto(txtEntrada);
            Analisis.tab(tokensForm1);
            txtEntrada.Text = "";
        }
            ...
            if (txtEntrada.Text != "")
            {
                ...
                if (Errores.ErrorSimboloDesco(txtEntrada, txtError) == false)
                {
                    ...
                    if (Analisis.errorActivado == false)
                    {
                        ...
                        try
                        {
                            errorActivado = Analisis.Sintaxis(tokensForm1, txtError, txtEntrada,cad, txtError);
        ...
        private void BtnInicializar_Click(object sender, EventArgs e)
        {
            ...
            double tiempoEjecucion = stopwatch.Elapsed.TotalSeconds;
            txtTiempo.Text = $"\n\nTiempo de inicialización: {tiempoEjecucion.ToString("0.000", CultureInfo.InvariantCulture)} segundos";
        }
